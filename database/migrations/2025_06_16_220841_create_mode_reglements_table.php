...
return new class extends Migration
{
    ...
    {
        Schema::create('mode_reglements', function (Blueprint $table): void {
            $table->id();
            $table->string('code');
            $table->string('name');
        ...
        Schema::table('tiers_fournisseurs', function (Blueprint $table): void {
            $table->foreignId('mode_reglement_id')->constrained();
        });

        Schema::table('tiers_clients', function (Blueprint $table): void {
            $table->foreignId('mode_reglement_id')->constrained();
        });
    }
