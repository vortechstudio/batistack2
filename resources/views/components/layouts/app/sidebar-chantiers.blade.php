    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 antialiased">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Chantiers')" class="grid">
                    ...
                    <flux:navlist.item icon="circle-gauge" :href="route('chantiers.dashboard')" :current="request()->routeIs('chantiers.dashboard')" wire:navigate>{{ __('Tableau de Bord') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
