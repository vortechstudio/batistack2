    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 antialiased">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Mon Espaces')" class="grid">
                    ...
                    <flux:navlist.item icon="home-modern" :href="route('account.dashboard')" :current="request()->routeIs('account.dashboard')" wire:navigate>{{ __('Tableau de Bord') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
