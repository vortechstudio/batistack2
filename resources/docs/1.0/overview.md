...
### 👥 **Ressources Humaines** (🆕 Améliorations majeures)
Simplifiez la gestion de vos équipes avec :
- **Fiches employés complètes** : Centralisez toutes les informations avec identifiants uniques
- **Gestion des contrats** : Créez et suivez les contrats avec signature électronique sécurisée
- **🆕 Signature électronique** : Intégration Yousign avec vérification SMS (OTP)
- **🆕 Gestion des comptes bancaires** : Interface dédiée avec validation IBAN/BIC
- **🆕 Module de gestion des congés** : Demandes, validations et suivi des absences
- **Système de paie** : Gérez la paie avec des profils personnalisables
- **🆕 Validation sélective des notes de frais** : Approuvez partiellement les remboursements
- **Suivi des absences** : Planifiez et suivez les congés
- **Portail salarié amélioré** : Nouveau tableau de bord et fonctionnalités étendues
...
### 👤 **Portail Salarié** (🆕 Interface repensée)
Offrez l'autonomie à vos employés avec :
- **🆕 Nouveau tableau de bord** : Interface claire et structurée
- **Accès personnel sécurisé** : Chaque employé a son espace
- **🆕 Gestion et consultation des documents** : Interface améliorée
- **Consultation des documents** : Bulletins de paie, contrats, attestations
- **🆕 Signature électronique sécurisée** : Signature avec vérification SMS
- **Gestion bancaire** : Mise à jour des coordonnées bancaires
- **🆕 Gestion des congés** : Demandes en ligne et suivi des soldes
...
- **🆕 Signature électronique certifiée** : Service Yousign avec validation SMS
...
- **🆕 Yousign** : Signature électronique sécurisée
- **🆕 OpenIban** : Validation automatique des coordonnées bancaires
...
- **🆕 Signature électronique** : Plus de déplacements pour signer
- **🆕 Validation sélective** : Traitement optimisé des notes de frais
...
- **🆕 Contrôle granulaire** : Validation partielle des remboursements
...
- **🆕 Portail salarié enrichi** : Plus d'autonomie pour les employés
- **🆕 Workflow de signature** : Processus dématérialisé
...
- **🆕 Indicateurs RH avancés** : Suivi des congés, signatures, etc.
...
- ✨ **Gestion des comptes bancaires salariés** avec validation IBAN/BIC automatique
- ✨ **Module de gestion des congés** avec interface Filament complète
- ✨ **Tables de paie et congés** dans l'administration RH
- ✨ **Notifications RH automatiques** pour les nouveaux salariés
- 🛠️ **Corrections des couleurs** par défaut pour tous les statuts

### Version 1.9.0 (Juillet 2025)
- ✨ **Nouveau tableau de bord salarié** avec interface claire et structurée
- ✨ **Gestion et consultation des documents** améliorées dans le portail
- ✨ **Signature électronique** avec vérification SMS (OTP) sécurisée
- ✨ **Compte à rebours** pour les contrats à signer
...
- ✨ **Intégration Yousign** pour la signature électronique sécurisée
- ✨ **Pad de signature** permettant la signature en ligne
- ✨ **Workflow automatisé** pour la transmission des contrats

### Fonctionnalités récentes ajoutées
- **🆕 Validation sélective des notes de frais** : Approuvez partiellement les remboursements
- **🆕 Gestion automatique des frais personnels** : Marquage automatique des frais non validés
- **🆕 Interface de validation améliorée** : Affichage détaillé avec format date-libellé-montant
- **🆕 Recalcul automatique** : Montants validés ajustés selon la sélection

## Support et Assistance

### 📖 **Ressources disponibles**
- **Documentation complète** : Guides détaillés pour chaque fonctionnalité
- **🆕 Guides de signature électronique** : Tutoriels pour les nouvelles fonctionnalités
...
- **Formation** : Sessions de formation pour vos équipes sur les nouvelles fonctionnalités
...
- **🆕 Innovations récentes** : Signature électronique, validation sélective, gestion des congés
...
- **Application mobile** complète pour le portail salarié
- **Notifications push** en temps réel
- **Gestion des formations** professionnelles
- **Intégrations bancaires** étendues
- **Intelligence artificielle** pour l'analyse des données RH
