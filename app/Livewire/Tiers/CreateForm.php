...
final class CreateForm extends Component implements HasSchemas
{
    ...
    public function mount(string $type, ?int $id = null): void
    {
        $this->type = $type;
            ...
            return $schema
                ->components([
                    Wizard::make([
                            ...
                            ->schema([
                                ...
                                Grid::make()
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('code_tiers')
                                            ->label('Code Client')
                                            ->default(Helpers::generateCodeTiers('c')),
                                    ]),
                        ...
                        Wizard\Step::make('Contact')
                            ->description('Contact Principale du client')
                            ->schema([
                                Grid::make(7)
                                    ->schema([
                                        Select::make('civilite')
                        ...
                        Wizard\Step::make('Client')
                            ->description('Information dédié au client')
                            ->schema([
                                Grid::make(2)
                                    ->schema([
                                        Select::make('code_comptable_general')
                                        ...
                                        TextInput::make('code_comptable_client')
    ...
    public function create()
    {
        ...
        if($this->type == 'supply') {
            ...
            $this->redirect(route('tiers.customers.list'));
        }
